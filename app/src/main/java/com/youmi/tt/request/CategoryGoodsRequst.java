 ...
 */
public class CategoryGoodsRequst extends BaseRequst {


    public CategoryGoodsRequst(ICategpryGoodView view, boolean show_error) {
    ...
    protected void onSuccess(JSONObject jsonObject, int url_type, int load_type, Bundle bundle) {
        ...
        try {
            if (lists == null)
            {
                ...
                //CommonUtils.log("CategoryGoodsRequst------------"+lists,"CategoryGoodsRequst");
                ((ICategpryGoodView) view).onSuccessGoods(url_type,load_type,lists);
            }
    ...
    public interface ICategpryGoodView extends IBaseView {
